...
run '/Users/Joonil/Documents/2017 Fall/CSC2503_Foundations of Computer Vision/Matlab/matlab/startup.m';
...
addpath([hmdir '/util']);
addpath('../data');
addpath(genpath('../../../../Matlab/matlab/utvisToolbox/edge'))
...
sigmaGM = 70; % Geman-McLure estimator scale parameter
